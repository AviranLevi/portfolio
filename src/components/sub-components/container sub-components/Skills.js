  ...
  render() {
    return (
      <div
        className={
          this.props.hover
            ? `skills container-child hover-on`
      ...
      >
        ...
        >
          ...
          <div className="skills-list">
            <div
              onClick={this.openFront}
              className={this.props.hover ? `skill skill-hover` : `skill`}
            >
              <h1>Front-End</h1>
              <CSSTransition
                in={this.props.openFront}
            ...
            <div
              onClick={this.openBack}
              className={this.props.hover ? `skill skill-hover` : `skill`}
            >
              <h1>Back-End</h1>
              <CSSTransition
                in={this.props.openBack}
                timeout={{ enter: 300, exit: 0 }}
                classNames="fade"
                unmountOnExit
              >
